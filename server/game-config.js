...
export const skills = {
  ...
  revenge: { cost: 150, cooldown: 10, target: true, once: true }, deception: { cost: 0, cooldown: 0 }, tail: { cost: 20, cooldown: 40, target: true }, betrayal: { cost: 10, cooldown: 10, target: true },
